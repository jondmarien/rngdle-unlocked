...
| **Version**                | `0.7.2` (`package.json`; Settings uses `VITE_APP_VERSION`)                                    |
| **Latest release**         | [v0.7.2](https://github.com/jondmarien/rngdle-unlocked/releases/tag/v0.7.2) (cut when tagged) |
