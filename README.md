...
[![Version](https://img.shields.io/badge/version-0.19.0-8b5cf6)](https://github.com/jondmarien/rngdle-unlocked/releases/tag/v0.19.0)
...
| Discord HTTP bot (`/roll`, `/board`, Rare+ gate)                          | ✅ Shipped (`v0.19.0`) — see [`docs/discord-bot.md`](./docs/discord-bot.md); public invite after Polar Rare+ webhook proven |
