...
July 2026 readability refactor summary: [`refactor-notes-2026-07.md`](Refactor-Notes). Arcade design: [`superpowers/specs/2026-07-09-arcade-mode-design.md`](./superpowers/specs/2026-07-09-arcade-mode-design.md).
...
- Thin handler: [`api/webhooks/polar.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/api/webhooks/polar.ts) -> [`server/polar/webhooks.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/server/polar/webhooks.ts) + [`server/polar/entitlements.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/server/polar/entitlements.ts).
...
- Product/ops detail: [`docs/polar-monetization.md`](Polar-Monetization).
...
- Thin `api/*` entrypoints use `defineHandler` + [`server/apiGuards.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/server/apiGuards.ts) (`requireUser` / `readJson` / `rateGuard`).
...
Static SPA routes use [`server/pageOg.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/server/pageOg.ts) titles/descriptions plus a shared brand card (`type=page`). **`/api/og` returns PNG** (Discord/Slack do not render SVG as `og:image`). Humans still get the SPA; bots are rewritten in `vercel.json`. Baseline `og:*` / `twitter:*` tags also live in `index.html` for non-rewritten crawlers.
...
- [README Status & roadmap](https://github.com/jondmarien/rngdle-unlocked#docs-moved-to-the-wiki) - feature -> release tag map
- [Polar monetization](Polar-Monetization) - products, webhooks, quota tiers
- [CHANGELOG](https://github.com/jondmarien/rngdle-unlocked/blob/main/CHANGELOG.md) - developer release notes
- [Arcade Mode design](./superpowers/specs/2026-07-09-arcade-mode-design.md)
- [Refactor notes (July 2026)](Refactor-Notes)
- [Opus audit + §H implementation status](https://github.com/jondmarien/rngdle-unlocked/blob/main/docs/opus-report.md)
