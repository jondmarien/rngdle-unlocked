...
**Brand icon for portals:** [`public/brand/oauth-icon-512.png`](https://github.com/jondmarien/rngdle-unlocked/blob/main/public/brand/oauth-icon-512.png) (512×512 PNG from the site favicon).
...
2. **App Icon:** upload [`public/brand/oauth-icon-512.png`](https://github.com/jondmarien/rngdle-unlocked/blob/main/public/brand/oauth-icon-512.png).
...
3. After create: **Upload logo** -> use [`public/brand/oauth-icon-512.png`](https://github.com/jondmarien/rngdle-unlocked/blob/main/public/brand/oauth-icon-512.png).
