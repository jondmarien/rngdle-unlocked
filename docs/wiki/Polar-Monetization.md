...
Player-facing disclosure: [`/payments`](https://rngdle-unlocked.chron0.tech/payments) (MoR legal page - not a storefront). Architecture diagram: [`ARCHITECTURE.md`](Architecture) (Polar entitlements section). Checkout storefront (Account Ranked Plus, P2 shipped): [`polar-checkout-foundation.md`](Ranked-Plus-Checkout).
...
- Format: raw JSON
- Handler: [`api/webhooks/polar.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/api/webhooks/polar.ts) -> [`server/polar/webhooks.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/server/polar/webhooks.ts)
...
- Entitlements: [`server/polar/entitlements.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/server/polar/entitlements.ts) -> `user_entitlements`
...
Constants: [`src/lib/ranked-limits.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/src/lib/ranked-limits.ts) (`RANKED_ROLLS_PER_HOUR`, `RANKED_TIER_CAPS`).
...
- Profile frames: [`src/lib/profile-frames.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/src/lib/profile-frames.ts) - Rare / Epic / Anomaly frames (`user.profile_frame`)
- Tier emblems: 12 seals under `public/avatars/tier/` - cumulative unlock **4 / 8 / 12** ([`src/lib/profile-avatars.ts`](https://github.com/jondmarien/rngdle-unlocked/blob/main/src/lib/profile-avatars.ts))
