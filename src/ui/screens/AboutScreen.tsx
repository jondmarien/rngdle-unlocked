      ...
      <section className="space-y-3">
        ...
        <ol className="list-decimal space-y-2 pl-5">
          ...
          <li>
            ...
            idle Roll tab (no session roll yet), see <em>Today&apos;s best</em>{' '}
            and <em>Best this week</em> from Ranked (server) free-play rolls.
            They hide while you spin so your result stays center stage.
          </li>
          <li>
