...
export const FAMILY_PILL: Record<BadgeFamily, { chip: string; label: string }> =
  {
    ...
    'atomic-registry': {
      chip: 'border-slate-500/40 bg-indigo-500/15 text-indigo-900 dark:text-indigo-200',
      label: 'Atomic Registry',
    },
    bases: {
    ...
    years: {
      chip: 'border-indigo-500/40 bg-indigo-500/15 text-indigo-900 dark:text-indigo-200',
      label: 'Years',
    },
    journey: {
