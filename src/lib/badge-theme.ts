...
export const RARITY_PILL: Record<RarityTier, string> = {
  ...
  anomaly: 'border-orange-500/40 bg-orange-500/15 text-orange-800 dark:text-orange-200',
...
export const RARITY_DIGIT_ON: Record<RarityTier, string> = {
  ...
  rare:
    'border-blue-600/40 bg-blue-500 text-white shadow-sm dark:bg-blue-400 dark:text-blue-950',
  epic:
    'border-violet-600/40 bg-violet-500 text-white shadow-sm dark:bg-violet-400 dark:text-violet-950',
  anomaly:
